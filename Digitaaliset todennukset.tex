...
DH:n ollessa altis välimieshyökkäykselle tarvitaan menetelmä yhteisen salaisuuden tiedon vaihtoon. Tähän soveltuu MAC-funktio (Message Authentication Code). MAC-funktiolla luodaan tiiviste, jonka vastaanottaja laskee yksityisellä avaimellaan. Jos tiivisteen arvo on odotettu oikea, on viesti saapunut eheänä perille. Aivan kuten allekirjoituksissakin viestin tiiviste salataan aluksi esimerkiksi AES-salausta käyttäen. Sen jälkeen lasketaan salasana käyttäen jotain julkista tunnettua MAC-funktiota. Lopuksi viestiin liitetään kyseinen laskettu salasana ja salataan viesti jollakin tiivistefunktiolla. 
